...
class OblivionDirect3DDevice9Ex : public IDirect3DDevice9Ex
{

public:
	OblivionDirect3DDevice9Ex(IDirect3D9Ex* D3DInterface, IDirect3DDevice9Ex* D3DDevice);
	~OblivionDirect3DDevice9Ex();
